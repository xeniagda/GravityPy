...
while True:
    ...
    if not restart:
        print("\033[2J\033[0;0H" + exitMsg)
                #["Very Good!", "Very good", "very good", "voru good", "VAEIRY GÜD", "gj", "good job", "V̪͎̯͇̝̫̗Ḙ̮̤̹̞R̵̹̗͖Ỵ̠̰̯̗͙̤͘ ͏͎̝͚̬̥̙͇G̴͍͉̮̤O҉̻̳͓O͈̠̞D"][levelNum % 8])
